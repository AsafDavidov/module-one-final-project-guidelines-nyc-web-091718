...
#Data imported from CSV of a few games from specific NBA players
#All data was taken from basketball-reference.com
#Files are in this order: Date,Opp,FG,FGA,TRB,AST,PTS
...
CSV.foreach("csv/lebron_stats.csv") do |row|
  game = Game.create({game_date:row[0],opponent_name:row[1]})
